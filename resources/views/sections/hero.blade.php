<section id="home" class="hero">
    ...
    <div class="hero__divider" aria-hidden="true">
        <svg viewBox="0 0 1200 44" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            <defs>
                <pattern id="honeycombDivider" width="36" height="36" patternUnits="userSpaceOnUse">
                    <circle cx="18" cy="18" r="9" fill="#FFFBF4" opacity="0.9" />
                </pattern>
            </defs>
            <rect x="0" y="10" width="1200" height="34" fill="url(#honeycombDivider)" />
        </svg>
    </div>
</section>