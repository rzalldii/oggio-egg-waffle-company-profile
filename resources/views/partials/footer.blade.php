<footer class="site-footer" id="footer">
    <div class="container">
        <!-- <div class="franchise-strip" style="margin-bottom: var(--space-xl);">
            ...
            <a href="https://wa.me/6287777235488?text=Halo%20Oggio%2C%20saya%20tertarik%20info%20kemitraan"
        ...
        <div class="footer__grid">
            <div>
                ...
                <div class="footer__social">
                    <a href="#" aria-label="Instagram Oggio Egg Waffle" target="_blank" rel="noopener">📷</a>
                    <a href="#" aria-label="TikTok Oggio Egg Waffle" target="_blank" rel="noopener">🎵</a>
                    <a href="https://wa.me/6287777235488" aria-label="WhatsApp Oggio Egg Waffle" target="_blank"
                        rel="noopener">💬</a>
                </div>
            </div>
            ...
            <div>
                ...
                <ul class="footer__links">
                    <li>Jl. Siwalankerto No. 128A, Surabaya</li>
                    <li>07.00–23.00 WIB</li>
                    <li><a href="https://wa.me/6287777235488">WhatsApp Order</a></li>
                </ul>
            </div>
        </div>

        <div class="footer__bottom">
            &copy; {{ date('Y') }} Oggio Egg Waffle. All rights reserved.
        </div>
    </div>
</footer>